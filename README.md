...
- 이와 달리, 부정 행위를 사전에 예방하기 위해 특정 대학교에서는 비디오 회의, 온라인 미팅, 화면 공유가 가능한 줌(Zoom)과 같은 웹엑스(Webex)를 활용해 수강생들이 웹엑스에 접속해서 앞, 뒤로 촬영하게 해서 교수가 실시간으로 학생의 모습을 볼 수 있게 하는 메뉴얼을 만들어서 전 학과가 시행하고 있다고 합니다.
