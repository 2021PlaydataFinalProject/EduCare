...
- 희성 : 평소에 다뤄보고 싶었던 Spring Security, Jwt를 공부하며 이를 활용하는 서비스를 구현해보아서 좋았고, 제가 아직 부족하고 더 배워야 할 것이 많다는 것을 다시금 느꼈습니다.
다들 수료를 앞두고 바쁜 와중에도 열심히 프로젝트 개발에 참여해 주어 정말 고맙고, 어려운 문제가 발생했을 때 서로 의견을 공유하며 해결했던 경험이 뿌듯했던 프로젝트였습니다!! 
